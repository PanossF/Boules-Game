...
{
	//set each ball to a position depending on index counter
	...
	static const float sep = (BALL_RADIUS * 5.0f);
	static const float rowSep = (0.1f);
	int row = 9;
	int rowIndex = index;
	while (rowIndex > row)
	{
	...
	position(1) = (rowSep * (row + 2));
	position(0) = 0.15 + ((((row - 1) * sep) / 2.0f) - (sep * (row - rowIndex)));
}
...
//declare the vertices of each cushion
void table::SetupCushions(void)
{
	...
	cushions[2].vertices[1](1) = -TABLE_Z + 0.9;

	cushions[3].vertices[0](0) = TABLE_X;
	cushions[3].vertices[0](1) = -TABLE_Z + 0.9;
	cushions[3].vertices[1](0) = TABLE_X - 0.9;
	cushions[3].vertices[1](1) = -TABLE_Z;

	cushions[4].vertices[0](0) = TABLE_X - 0.9;
...
//declare the vertices of each cushion
void table::SetupCushions2(void)
{
	cushions[0].vertices[0](0) = -TABLE_X - 0.6;
	cushions[0].vertices[0](1) = -TABLE_Z +1.9;
	cushions[0].vertices[1](0) = -TABLE_X;
	cushions[0].vertices[1](1) = TABLE_Z;
	...
	cushions[4].vertices[0](0) = TABLE_X - 0.9;
	cushions[4].vertices[0](1) = -TABLE_Z;
	cushions[4].vertices[1](0) = -TABLE_X -0.6;
	cushions[4].vertices[1](1) = -TABLE_Z +1.9;
...
//declare the vertices of each cushion
void table::SetupCushions3(void)
{
	cushions[0].vertices[0](0) = -TABLE_X;
	cushions[0].vertices[0](1) = -TABLE_Z + 1.2;
	cushions[0].vertices[1](0) = -TABLE_X;
	cushions[0].vertices[1](1) = TABLE_Z;
	...
	cushions[4].vertices[0](1) = -TABLE_Z;
	cushions[4].vertices[1](0) = -TABLE_X;
	cushions[4].vertices[1](1) = -TABLE_Z + 1.2;
...
//declare the vertices of each cushion
void table::SetupCushions4(void)
{
	cushions[0].vertices[0](0) = -TABLE_X - 1;
	cushions[0].vertices[0](1) = -TABLE_Z;
	cushions[0].vertices[1](0) = -TABLE_X;
	cushions[0].vertices[1](1) = TABLE_Z;
	...
	cushions[2].vertices[0](0) = TABLE_X;
	cushions[2].vertices[0](1) = TABLE_Z;
	cushions[2].vertices[1](0) = TABLE_X + 1;
	cushions[2].vertices[1](1) = -TABLE_Z;

	cushions[3].vertices[0](0) = TABLE_X + 1;
	cushions[3].vertices[0](1) = -TABLE_Z;
	...
	cushions[4].vertices[0](1) = -TABLE_Z;
	cushions[4].vertices[1](0) = -TABLE_X -1;
	cushions[4].vertices[1](1) = -TABLE_Z;
...
//declare the vertices of each cushion
void table::SetupCushions5(void)
{
	cushions[0].vertices[0](0) = -TABLE_X;
	cushions[0].vertices[0](1) = -TABLE_Z +0.9	;
	cushions[0].vertices[1](0) = -TABLE_X;
	cushions[0].vertices[1](1) = TABLE_Z;
	...
	cushions[4].vertices[0](1) = -TABLE_Z;
	cushions[4].vertices[1](0) = -TABLE_X;
	cushions[4].vertices[1](1) = -TABLE_Z +0.9;
...
//calculates the distance of jack ball with a player's ball
float table::JackDistance(ball& b)
{
	vec2 relPosn = gTable.balls[0].position - b.position;
	float dist = (float)relPosn.Magnitude();
	return dist;
